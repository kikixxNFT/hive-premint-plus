...
import { CircleCheck, CircleDashed, Trophy, CircleX, QuestionMark } from 'tabler-icons-react';

type Icon = Record<'lost' | 'register' | 'registered' | 'won' | 'unknown' | 'legend', React.ReactElement>

const LostIcon = ({ variant }: { variant?: ThemeIconVariant }) => (
    <ThemeIcon variant={variant} color="grape" size={24} radius="xl">
        <CircleX size={16} />
    </ThemeIcon>)
